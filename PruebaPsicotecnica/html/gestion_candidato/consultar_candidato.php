...
<body>
    ...
    $identificaion = $_POST['codigo'];

    $sentencia = $bd->prepare("SELECT * FROM candidato where identificacion  = ?");
    $resultado = $sentencia->execute([$identificaion]);
                        ...
                        <tbody class="bg-light">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editar.php?codigo= <?php echo $dato->id_candidato; ?>">
                                            <button class="btn btn-outline-primary" id="btn-editar">Editar</button>
                                        </a>
                                    </td>
                                    <td>
                                        <a onclick="return confirm('¿Seguro que quiere eliminar esos datos?');" href="eliminar.php?codigo= <?php echo $dato->id_candidato; ?>">
